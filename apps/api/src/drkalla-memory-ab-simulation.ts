  ...
  switch (category) {
    ...
    case 'asr_aliases':
      return [
        ...
        'Habt ihr Haartrockner',
        'Ich suche einen Shaver',
        'Habt ihr Rasierer',
        ...
        'Habt ihr Barberstühle',
        'Ich suche einen Friseursessel',
        'Habt ihr Salonstühle',
        'Habt ihr Ablagen',
        ...
        'Habt ihr Kosmetikbedarf',
        'Habt ihr Depilationszubehör',
        'Habt ihr Depilationswachs',
        'Ich brauche Hitzeschutz',
        'Ich brauche Haarpflege',
        'Habt ihr Ampullen',
        'Ich suche eine Haarkur',
        'Habt ihr eine klärende Spülung',
        'Ich suche Neutralshampoo',
        'Habt ihr Haarfärbemittel',
        'Ich suche Nackenstreifen',
        'Ich brauche Einweghandschuhe',
        'Habt ihr Haarschaum',
        'Ich brauche Bright-Wax',
        'Habt ihr Stylingwax',
        'Ich suche Gel-Spray',
        'Habt ihr Volumen-Puder',
        'Habt ihr Glanz-Spray',
        'Habt ihr Laminier-Spray',
        'Ich suche Vorbereitungsshampoo',
        'Habt ihr Strähnchenfolie',
        'Ich brauche Blond-Booster',
        'Habt ihr Desinfektionswagen',
        'Ich brauche eine UVC Lampe',
        ...
        'Habt ihr Accessories',
        'Ich suche Zubehör',
        'Habt ihr Salonbedarf',
        'Ich brauche Barber-Bedarf',
      ][index % 100] ?? 'Latasse fuer Herren';
  ...
  switch (testCase.category) {
    ...
    case 'asr_aliases': {
      ...
      const catalogueProductTypes: Array<{ pattern: RegExp; label: string }> = [
        ...
        { pattern: /Shampoos?|Neutralshampoo/i, label: 'Shampoo' },
        { pattern: /Haarmasken?|Haarkur/i, label: 'Haarmaske' },
        { pattern: /Conditioner|klärende Spülung|Pflegespülung/i, label: 'Conditioner/Spülung' },
        { pattern: /Leave-in/i, label: 'Leave-in' },
        { pattern: /Haarserum/i, label: 'Serum' },
        { pattern: /Kämme|Bürsten|Scheren|Delrin Hair Comb|Professional Comb|Färbeschalen|Färbepinsel|Alufolie|Strähnenfolie|Glätteisen|Föhn|Haartrockner|Shaver|Rasierer|Barttrimmer|Haarschneidemaschinen|Schneidemaschinen|Rasierpinsel|Rasierklingen|Haarstaubwedel|Nackenwedel/i, label: 'Friseur-Tool' },
        ...
        { pattern: /Spitzenpapier|Nackenpapier|Friseurumhänge|Handschuhe|Einweghandschuhe|professionelles Salonhandtuch|Salon-Verbrauchsmaterial/i, label: 'Salon-Verbrauchsmaterial' },
        { pattern: /Sprühflaschen|Watteschnur/i, label: 'Salon-Verbrauchsmaterial' },
        { pattern: /Spiegel|Aufsteller|Accessories|\bZubehör\b|Salonbedarf/i, label: 'Salon-Zubehör' },
        ...
        { pattern: /Kosmetikbedarf|Depilationszubehör|Depilationswachs/i, label: 'Kosmetikbedarf' },
        { pattern: /Hitzeschutz|Haarpflege|Ampullen/i, label: 'Haarpflege' },
        { pattern: /Nackenstreifen/i, label: 'Salon-Verbrauchsmaterial' },
        { pattern: /Haarschaum|Haarstyling|Bright-Wax|Stylingwax|Gel-Spray|Volumen-Puder|Glanz-Spray|Laminier-Spray/i, label: 'Styling' },
        { pattern: /Vorbereitungsshampoo/i, label: 'Shampoo' },
        { pattern: /Haarfärbemittel/i, label: 'Haarfarbe/Farbcreme' },
        { pattern: /Strähnchenfolie|UVC Lampe|Barber-Bedarf|Hair Dryer|Heizstab/i, label: 'Friseur-Tool' },
        { pattern: /Blond-Booster/i, label: 'Blondierung' },
        { pattern: /Desinfektionswagen/i, label: 'Salonmöbel/-ausstattung' },
