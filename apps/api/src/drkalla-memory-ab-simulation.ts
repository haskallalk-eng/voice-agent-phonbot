  ...
  switch (testCase.category) {
    ...
    case 'asr_aliases': {
      ...
      const catalogueProductTypes: Array<{ pattern: RegExp; label: string }> = [
        ...
        { pattern: /Kosmetikbedarf|Depilationszubehör/i, label: 'Kosmetikbedarf' },
        { pattern: /Hitzeschutz|Ampullen/i, label: 'Haarpflege' },
        { pattern: /Nackenstreifen/i, label: 'Salon-Verbrauchsmaterial' },
        { pattern: /Haarschaum|Bright-Wax|Glanz-Spray|Laminier-Spray/i, label: 'Styling' },
        { pattern: /Vorbereitungsshampoo/i, label: 'Shampoo' },
        { pattern: /Strähnchenfolie|UVC Lampe/i, label: 'Friseur-Tool' },
