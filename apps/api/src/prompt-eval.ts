...
const PROMPT_EVAL_RULES: PromptEvalRule[] = [
  ...
  },
  {
    ...
    title: 'Uhrzeiten, Datum und Wochentage werden sprechsicher normalisiert',
    layer: 'tts',
    severity: 'critical',
    kinds: ['platform', 'dashboard', 'outbound', 'sales'],
    requirement: 'Terminzeiten und Wochentage duerfen nicht technisch, abgekuerzt oder mit falschen fuehrenden Nullen gesprochen werden.',
    ...
    recommendation: 'TTS-Zeitregel ergaenzen: 09:00 -> neun Uhr, 10:05 -> zehn Uhr null fuenf, Mo-Fr -> Montag bis Freitag, Datum als Worte, Tool-Sprechfelder nutzen.',
    promptManagerArea: 'TTS-Tester',
    sampleInput: 'Biete mir Mo-Fr 09:00 und 10:05 an.',
  },
  {
    id: 'spoken-weekday-normalization',
    title: 'Wochentag-Kuerzel werden nie gesprochen',
    layer: 'tts',
    severity: 'high',
    kinds: ['platform', 'dashboard'],
    requirement: 'Oeffnungszeiten wie Mo-Fr, Di-Sa, Sa oder So muessen fuer Voice ausgeschrieben werden.',
    requiredAll: [/Mo-Fr/i, /Montag bis Freitag/i],
    requiredAny: [/Di-Sa.*Dienstag bis Samstag/i, /Sa.*Samstag/i, /Wochentag/i, /Abkuerzung/i],
    recommendation: 'Opening-Hours-Regel ergaenzen: technische Kuerzel nur intern nutzen, fuer Anrufer immer ausgeschriebene Wochentage sprechen.',
    promptManagerArea: 'TTS-Tester',
    sampleInput: 'Wann habt ihr Mo-Fr und Sa offen?',
  },
  {
