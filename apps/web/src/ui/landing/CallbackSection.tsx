              ...
              {state === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5 h-full flex flex-col justify-center">
                  ...
                  <button
                    ...
                    className="crystal-button w-full rounded-xl px-6 py-3.5 font-bold text-white text-sm disabled:opacity-40 transition-all duration-300 hover:scale-[1.02] cursor-pointer"
                  >
                    {state === 'loading' ? (
