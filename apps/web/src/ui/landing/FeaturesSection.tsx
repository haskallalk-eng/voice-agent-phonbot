  ...
  return (
    <section id="features" className="relative z-10 px-6 py-24 max-w-6xl mx-auto ambient-glow">
      <div className="text-center mb-16">
        <h2 className="text-3xl sm:text-4xl font-extrabold mb-3">Was <span className="bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(135deg, #F97316, #06B6D4)' }}>Phonbot</span> für dich erledigt</h2>
